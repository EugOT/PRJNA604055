---
title: "Difference in signalling between astrocytic Insr+/- groups of the hypothalamic arcuate nucleus and Agrp or POMC neurons in response to high-fat diet"
...
sc.pl.embedding(
    ...
    palette="nipy_spectral",
    show=True,
    save="-pacmap-int-HF-diet-insr-status.pdf",
)
```
...
sc.pl.embedding(
    ...
    palette="nipy_spectral",
    show=True,
    save="-pacmap-adgene-HF-diet-insr-status.pdf",
)
```
...
with matplotlib.rc_context({"figure.figsize": (5.5, 4)}):
    sc.pl.violin(
        ...
        palette="nipy_spectral",
        show=True,
        save="-violin-adgene-HF-diet-insr-status.pdf",
    )
```
...
sc.pl.embedding(
    ...
    palette="nipy_spectral",
    show=True,
    save="-pacmap-subset-int-HF-diet-insr-status.pdf",
)
```
...
sc.pl.embedding(
    ...
    palette="nipy_spectral",
    show=True,
    save="-pacmap-subset-adgene-HF-diet-insr-status.pdf",
)
```
...
n2a_hfd.save(filename="liana-dotplot-logfc-HF-diet-n2a-insr-status.pdf")
```
...
n2a_hfd.save(filename="liana-dotplot-specificity_rank-HF-diet-n2a-insr-status.pdf")
```
...
n2a_hfd.save(filename="liana-dotplot-magnitude_rank-HF-diet-n2a-insr-status.pdf")
```
...
a2n_hfd.save(filename="liana-dotplot-logfc-HF-diet-a2n-insr-status.pdf")
```
...
a2n_hfd.save(filename="liana-dotplot-specificity_rank-HF-diet-a2n-insr-status.pdf")
```
...
a2n_hfd.save(filename="liana-dotplot-magnitude_rank-HF-diet-a2n-insr-status.pdf")
```
...
```{python}
adata_hfd.write(
    f"/data/{bioproject}/data/velocity-signalling/{bioproject}-signalling-treatment-insr-status.h5ad"
)
```
