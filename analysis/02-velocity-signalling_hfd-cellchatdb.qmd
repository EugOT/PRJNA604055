...
n2a_norm.save(filename="liana-dotplot-insr-logfc-normal-diet-n2a-cellchatdb.pdf")
```
...
n2a_norm.save(
    filename="liana-dotplot-insr-specificity_rank-normal-diet-n2a-cellchatdb.pdf"
)
```
...
n2a_norm.save(
    filename="liana-dotplot-insr-magnitude_rank-normal-diet-n2a-cellchatdb.pdf"
)
```
...
n2a_hfd.save(filename="liana-dotplot-logfc-HF-diet-n2a-cellchatdb.pdf")
```
...
n2a_hfd.save(filename="liana-dotplot-specificity_rank-HF-diet-n2a-cellchatdb.pdf")
```
...
n2a_hfd.save(filename="liana-dotplot-magnitude_rank-HF-diet-n2a-cellchatdb.pdf")
```
