---
title: "CellChat signalling analysis of Arcuate Nucleus/Median Eminence astrocytes dataset from Deng G et al 2020"
...
Idents(srt, cells = WhichCells(srt, expression = (Insr > 0 & Rbfox3 < 5 & cell_name %in% astrocytes_idx))) <- "Astro_INSR+"
Idents(srt, cells = WhichCells(srt, expression = (Insr == 0 & Rbfox3 < 5 & cell_name %in% astrocytes_idx))) <- "Astro_INSR-"
...
if (file.exists(here(data_dir, "cellchat-deng2020-HFD_and_control.rds"))) {
    object.list <- readr::read_rds(file = here(data_dir, "cellchat-deng2020-HFD_and_control.rds"))
} else {
  ...
  readr::write_rds(object.list, file = here(data_dir, "cellchat-deng2020-HFD_and_control.rds"))
}
```
...
readr::write_rds(cellchat, file = here(data_dir, "cellchat-comparison-deng2020-HFD_vs_control.rds"))
```
