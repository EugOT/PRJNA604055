...
n2a_hfd.save(filename="liana-dotplot-logfc-HF-diet-n2a-insr-status-cellchatdb.pdf")
```
...
n2a_hfd.save(
    filename="liana-dotplot-specificity_rank-HF-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_hfd.save(
    filename="liana-dotplot-magnitude_rank-HF-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_hfd.save(filename="liana-dotplot-insr-logfc-HF-diet-n2a-insr-status-cellchatdb.pdf")
```
...
n2a_hfd.save(
    filename="liana-dotplot-insr-specificity_rank-HF-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_hfd.save(
    filename="liana-dotplot-insr-magnitude_rank-HF-diet-n2a-insr-status-cellchatdb.pdf"
)
```
...
a2n_hfd.save(filename="liana-dotplot-logfc-HF-diet-a2n-insr-status-cellchatdb.pdf")
```
...
a2n_hfd.save(
    filename="liana-dotplot-specificity_rank-HF-diet-a2n-insr-status-cellchatdb.pdf"
)
```
...
a2n_hfd.save(
    filename="liana-dotplot-magnitude_rank-HF-diet-a2n-insr-status-cellchatdb.pdf"
)
```
